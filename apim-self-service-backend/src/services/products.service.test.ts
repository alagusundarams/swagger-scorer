...
vi.mock('./policy-builder.service.js', () => mockPolicyBuilder);
vi.mock('./spec-fetcher.service.js', () => mockSpecFetcher);
vi.mock('./apim.service.mock.js', () => mockApimMock);
...
describe('Products Service Final Final', () => {
    ...
    it('should achieve 100% logic coverage', async () => {
        ...
        await productsService.updateProduct('p1', { ownerTeamId: 't2' });
        ...
        await productsService.updateProductPolicy('p1', '<xml/>');
