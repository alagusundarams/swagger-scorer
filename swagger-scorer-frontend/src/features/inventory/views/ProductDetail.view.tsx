                ...
                <div className="mb-12">
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        {product.apis.length === 0 ? (
                            <div className="p-12 text-center border-2 border-dashed border-red-200 dark:border-red-900/30 rounded-[2rem] bg-red-50/50 dark:bg-red-900/10">
                                <div className="text-3xl mb-4">⚠️</div>
                                <h3 className="text-sm font-black text-red-600 dark:text-red-400 uppercase tracking-widest mb-2">Governance Violation: Empty Product</h3>
                                <p className="text-xs text-red-500/70 max-w-md mx-auto font-medium">
                                    This product container has no registered API Interfaces. It cannot be deployed or subscribed to until at least one interface definition is attached via the Registry CLI.
                                </p>
                            </div>
                        ) : (
                                    ...
                                    <div className="flex items-center gap-8">
                                        ...
                                        <div>
                                            <h3 className="text-lg font-black text-gray-900 dark:text-white mb-1">
                                                {api.displayName || <span className="text-amber-500 italic">Untitled Interface</span>}
                                            </h3>
                                            <p className="text-sm text-gray-400 font-medium flex items-center gap-2">
                                                Route Base:
                                                {api.path ? (
                                                    <code className="bg-gray-100 dark:bg-slate-900 px-2 py-0.5 rounded text-blue-600 font-mono italic">{api.path}</code>
                                                ) : (
                                                    <span className="text-[10px] font-black uppercase tracking-widest text-red-500 bg-red-50 px-2 py-0.5 rounded border border-red-100">Missing Path</span>
                                                )}
                                            </p>
                                        </div>
                                    </div>
