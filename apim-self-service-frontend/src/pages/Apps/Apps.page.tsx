 ...
 * ------------------------------------------------------------------
 * 📍 Purpose:
 * Route Entry Point for `/apps`.
 * Manages User's "Consumer Identities" (App Registrations).
 * 
 * 🔄 Data Flow:
 * 1. `useAuth` -> Gets current user's team context.
 * 2. `useConsumerStore` -> Fetches App Registrations for the user's team.
 * 3. Client Interaction -> User links new Azure AD Apps.
 * 
 * 🧩 MFE Boundaries:
 * - This Page orchestrates the "Consumer" feature (specifically Identity Management).
 * - It serves as a self-service portal for App Registration.
 * ------------------------------------------------------------------
 */
