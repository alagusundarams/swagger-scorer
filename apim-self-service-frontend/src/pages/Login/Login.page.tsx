 ...
 * Handles user authentication via Mock or SSO provider.
 * 
 * 🔄 Data Flow:
 * 1. User Input -> Email/Password.
 * 2. `useAuth` -> Triggers Login Action.
 * 3. Redirection -> On established session, redirects to Home `/`.
 * 
 * 🧩 MFE Boundaries:
 * - This Page orchestrates the "Auth" feature.
 * - It is a standalone entry point with no shell dependencies (initially).
 * ------------------------------------------------------------------
 */
