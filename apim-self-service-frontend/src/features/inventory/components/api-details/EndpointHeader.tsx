 ...
 * EndpointHeader
 * 
 * Displays the key details of a specific API endpoint (method, path, description).
 * Used at the top of the Endpoint Detail view.
 */
import { type Operation } from '../../types/inventoryTypes';
