    ...
    return (
        ...
        >
            <div className="p-7 flex-1">
                <div className="flex justify-between items-start mb-6">
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className={`px-2 py-0.5 text-[9px] font-black rounded-lg border uppercase tracking-widest ${getEnvironmentTheme(subscription.state === 'active' ? 'PROD' : 'DEV').bg} ${getEnvironmentTheme(subscription.state === 'active' ? 'PROD' : 'DEV').text} ${getEnvironmentTheme(subscription.state === 'active' ? 'PROD' : 'DEV').border}`}>
                                {subscription.state}
                            </span>
                        </div>
                ...
                {/* Health & Performance (Removed Mocks) */}
            </div>
