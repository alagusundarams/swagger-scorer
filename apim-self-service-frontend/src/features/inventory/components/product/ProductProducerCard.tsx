...
import { getEnvironmentTheme, getScoreTheme } from '../../../../utils/statusUtils';
...
export const ProductProducerCard: React.FC<ProductProducerCardProps> = ({
    ...
    const scoreClass = getScoreTheme(score);
            ...
            <div className="p-7 flex-1">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <span className={`px-2.5 py-1 text-[9px] font-black rounded-lg border uppercase tracking-wider ${getEnvironmentTheme(product.environment || '').bg} ${getEnvironmentTheme(product.environment || '').text} ${getEnvironmentTheme(product.environment || '').border}`}>
                            {product.environment}
                        </span>
